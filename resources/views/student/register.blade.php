	...
	<div class="main-content">
		...
		<div class="sticky-header header-section ">
			<div class="header-left">
				...
				<div class="logo">
					<a href="{{route('home') }}">
						<h3 style="padding-top: 3%">STUDENT </h3>
					</a>
				</div>
				<!--//logo-->
				<div class="clearfix"> </div>
		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="forms">
					<h3 class="title1 middle">STUDENT REGISTRATION</h3>
					<div class="form-grids row widget-shadow" data-example-id="basic-forms"> 
						...
						<div class="form-title">
							<h4 class="middle">COURSES REGISTERED</h4>
						</div>
						<div class="form-body table-responsive">
							<table class="table">
								<thead>
							...
							<div class="checkbox">
								<label style="width: 100%;">
									<form action="{{route('student-register')}}" mathod="get">
										<input type="checkbox" required value="remember-me"> 
											Please check this box to confirm the above details.
										<br><br><br><br>
