            ...
            <div class="navbar-collapse">
				<nav class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left" id="cbp-spmenu-s1">
					<ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="{{ route('create-new-course') }}"><i class="fa fa-home nav_icon active"></i>Add new course</a>
                        </li>
		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="forms">
					...
					<div class="form-grids row widget-shadow" data-example-id="basic-forms" style="text-align: center"> 
                                ...
                                <div class="form-body table-responsive">
                                    <table class="table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>{{$course->courseCode}}</a></td>
                                                <td>{{$course->courseName}}</td>
                                                <td><a href="{{ route('course-show', $course->id) }}"><button>VIEW</button></a> <a href="{{ route('course-delete', $course->id) }}"><button>DELETE</button></a></td>
                                            </tr>
											@endforeach
                                        </tbody>
